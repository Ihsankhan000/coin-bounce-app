   ...
   <div className={styles.container}>
     ...
     <div className={styles.layout}>
      ...
      <Routes>
          ...
          <Route path='blog/:id' exact element={ <Protected isAuth={isAuth}> <div className={styles.main}> <BlogDetails /> </div> </Protected> } />
          <Route path='blog-update/:id' exact element={ <Protected isAuth={isAuth}> <div className={styles.main}> <UpdateBlog /> </div> </Protected> } />
